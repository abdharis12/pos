...
import { productsIndex, productsStore } from '@/routes';
...
export default function ProductCreate({ categories }: Props) {
    ...
    const submit = () => {
        post(productsStore(), { forceFormData: true });
    };
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="rounded-3xl bg-white p-6 ring-1 ring-stone-200">
                                ...
                                <button
                                    ...
                                    className={`w-full rounded-2xl p-4 text-sm font-bold transition-all duration-300 ${data.is_active
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className={`flex h-6 w-11 items-center rounded-full transition-all duration-300 ${data.is_active ? 'bg-emerald-500' : 'bg-stone-300'}`}>
                                            <div className={`h-5 w-5 rounded-full bg-white shadow-sm transition-all duration-300 ${data.is_active ? 'translate-x-5' : 'translate-x-0.5'}`} />
                                        </div>
                                    </div>
                                </button>
                            </div>
